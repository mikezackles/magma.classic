...
START_TEST (check_digits)
	{
		...
		for (uint64_t i = 0; i < 8192; i++) {
			...
			i8 = core_config.random.rand_get_int8();
			i16 = core_config.random.rand_get_int16();
			i32 = core_config.random.rand_get_int32();
			i64 = core_config.random.rand_get_int64();

			ui8 = core_config.random.rand_get_uint8();
			ui16 = core_config.random.rand_get_uint16();
			ui32 = core_config.random.rand_get_uint32();
			ui64 = core_config.random.rand_get_uint64();

			ck_assert_int_eq(int8_digits(i8), snprintf(buf, 1024, "%hhi", i8));
			ck_assert_int_eq(int16_digits(i16), snprintf(buf, 1024, "%hi", i16));
			ck_assert_int_eq(int32_digits(i32), snprintf(buf, 1024, "%i", i32));
			ck_assert_int_eq(int64_digits(i64), snprintf(buf, 1024, "%li", i64));
			ck_assert_int_eq(uint8_digits(ui8), snprintf(buf, 1024, "%hhu", ui8));
			ck_assert_int_eq(uint16_digits(ui16), snprintf(buf, 1024, "%hu", ui16));
			ck_assert_int_eq(uint32_digits(ui32), snprintf(buf, 1024, "%u", ui32));
			ck_assert_int_eq(uint64_digits(ui64), snprintf(buf, 1024, "%lu", ui64));
		}
